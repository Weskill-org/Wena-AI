-- Update default wallet credits to 50
ALTER TABLE wallets ALTER COLUMN credits SET DEFAULT 50;

-- Update handle_new_user function to give 50 default credits and 100 bonus credits for referrals
...
BEGIN
  ...
  -- Check if user was referred and reward both users
