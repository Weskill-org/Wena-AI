...
const VoiceOrb: React.FC<VoiceOrbProps> = ({
  ...
  return <div className="relative flex items-center justify-center w-40 h-40 md:w-52 md:h-52 cursor-pointer" onClick={onClick}>
            {/* Outer Glow Ring */}
            <motion.div animate={{
      ...
      ease: "easeInOut"
        ...
        duration: 2
                        ...
                        <div className="flex gap-1">
                            <motion.div animate={{
            height: 8 + visualVolume * 30
          }} className="w-1 bg-white rounded-full" />
                            <motion.div animate={{
            height: 12 + visualVolume * 45
          }} className="w-1 bg-white rounded-full" />
                            <motion.div animate={{
            height: 8 + visualVolume * 30
          }} className="w-1 bg-white rounded-full" />
                        </div>
                    </motion.div> : <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-slate-400 md:w-8 md:h-8">
