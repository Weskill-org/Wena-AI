...
import { Award, ChevronLeft, Trophy, Star, Shield, Zap } from "lucide-react";
                            ...
                            >
                                ...
                                {earned && (
                                    <motion.div
                                        initial={{ scale: 0 }}
                                        animate={{ scale: 1 }}
                                        className="mt-3 bg-primary/20 text-primary text-[8px] font-bold py-1 px-2 rounded-full flex items-center gap-1"
                                    >
